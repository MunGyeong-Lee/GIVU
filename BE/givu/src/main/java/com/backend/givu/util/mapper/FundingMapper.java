...
public class FundingMapper {
    ...
    public static FundingDocument toDocument(Funding funding) {
        ...
        return new FundingDocument(
                ...
                funding.getCategory() != null ? funding.getCategory().name() : null,
                funding.getCategoryName(),
                funding.getParticipantsNumber(),
                funding.getFundedAmount(),
                funding.getScope() != null ? funding.getScope().name() : null,
                funding.getStatus() != null ? funding.getStatus().name() : null,
                funding.getImage(),
                createdAt,
                updatedAt
        );
